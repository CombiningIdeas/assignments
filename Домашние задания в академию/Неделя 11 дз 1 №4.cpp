...
//{
//	int balance = 14; // нужен чтобы когда выводитс€ масть и значение 
...
//
//
//	// нужно дл€ дес€тки чтобы выводило два числа в остальный случа€х или символ 
//	// или одно число
//	if (card == 9)
//	{
//		balance--;
...
//{
//	// «адание 4. 
//	/*Ќаписать функцию, вывод€щую на экран
//	переданную ей игральную карту.*/
//	// так как нудно работать с символами то русский €зык нельз€ использовать 
