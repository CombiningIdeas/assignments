...
Сопроводить каждую новую строчку тройным звуковым сигналом.
*/
/*
#include <iostream>
...
используя только линейный алгоритм, осуществит корректировку введенной денежной суммы в правильную форму.
